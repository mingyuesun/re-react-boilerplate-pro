...
import { Avatar, Dropdown, Menu, Breadcrumb, Popover } from 'antd'
		...
		const userMenu = (
			<Menu>
				<Menu.Item disabled className={`${prefixCls}-userMenuItem`}>
					<UserOutlined className={`${prefixCls}-userMenuIcon`}/>
					<span>{intl.formatMessage({ id: 'basicLayout_profile' })}</span>
				</Menu.Item>
				<Menu.Item disabled className={`${prefixCls}-userMenuItem`}>
					<SettingOutlined  className={`${prefixCls}-userMenuIcon`}/>
				...
				<Menu.Item className={`${prefixCls}-userMenuItem`}>
					<div onClick={logout} role="presentation">
						<LogoutOutlined className={`${prefixCls}-userMenuIcon`}/>
			...
			<div className={`${prefixCls}-header`}>
				<div className={`${prefixCls}-notice`}>
					...
					>
						...
						<BellOutlined className={`${prefixCls}-noticeIcon`}/>
					</Popover>
				</div>
...
export default connect(mapStateToProps, mapDispatchToProps)(injectIntl(BasicLayout))
